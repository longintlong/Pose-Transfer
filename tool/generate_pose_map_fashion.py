...
# annotations_file = 'demo_data/demo-resize-annotation-test.csv' #pose annotation path
# save_path = 'demo_data/testK' #path to store pose maps
...
def compute_pose(annotations_file, savePath, sigma):
